...
class TodoItemsRepository {
    ...
    private fun getValuesItems(): List<TodoItem> {
        ...
        items.add(TodoItem("1", "Купить продукты в супермаркете", TodoItem.Priority.NORMAL, null, false, dateFormat.parse("10/06/2023")!!, null))
        ...
        items.add(TodoItem("8", "Сделать список задач на выходные", TodoItem.Priority.LOW, null, false, dateFormat.parse("11/06/2023")!!, null))
        ...
        items.add(TodoItem("11", "Получить новый паспорт в паспортном столе", TodoItem.Priority.HIGH, null, false, dateFormat.parse("12/06/2023")!!, null))
