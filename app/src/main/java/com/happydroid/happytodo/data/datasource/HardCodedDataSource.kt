...
class HardCodedDataSource {
    ...
    init {
        ...
        items.add(TodoItem("4", "Подготовить презентацию для встречи с клиентом на следующей неделе", TodoItem.Priority.HIGH, dateFormat.parse("10/07/2023")!!, false, dateFormat.parse("11/06/2023")!!, null))
